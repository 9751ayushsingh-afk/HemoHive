...
function Band({ maxSpeed = 50, minSpeed = 0 }) {
 ...
 return (
  <>
   <mesh ref={band}>
    <meshLineGeometry />
    <meshLineMaterial color="white" depthTest={false} resolution={[1920, 1080]} transparent lineWidth={1} />
   </mesh>
   ...
   >
    ...
    <group scale={isSmall ? 0.8 : 1}>
     <mesh geometry={nodes.card.geometry} material={materials.card} />
     <mesh position={[0, 0, 0.01]} geometry={nodes.lanyard.geometry}>
