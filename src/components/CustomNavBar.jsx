            ...
            <nav className="flex flex-col gap-6">
              ...
              {status === 'authenticated' ? (
                <>
                  ...
                  >
                    <button onClick={() => { signOut({ callbackUrl: `${window.location.origin}/login` }); onClose(); }} className="text-xl text-white/60 hover:text-white text-left">
                      Logout
                    </button>
                  </motion.div>
                </>
          ...
          <nav className="custom-nav">
            ...
            {status === 'authenticated' ? (
              <>
                ...
                <button onClick={() => signOut({ callbackUrl: `${window.location.origin}/login` })} className="custom-nav-item">
                  Logout
                </button>
              </>
            ) : (
