            ...
            <div className="card">
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="form">
                    ...
                    <motion.button
                        ...
                        className="w-full py-3 flex items-center justify-center gap-3 bg-white/5 border border-white/10 rounded-lg font-bold text-white hover:bg-white/10 transition-all duration-300"
